  ...
  head: () => ({
    meta: [
      ...
      { title: "Caden Conde — Computer Science & AI" },
      {
        name: "description",
        content:
          "Portfolio of Caden Conde — Computer Science & AI student at The Ohio State University. Builder, problem-solver, hackathon winner.",
      },
      { name: "author", content: "Caden Conde" },
      { property: "og:title", content: "Caden Conde — Computer Science & AI" },
      {
        property: "og:description",
        content:
          "CS & AI student at OSU. Builder, problem-solver, hackathon winner.",
      },
